      ...
      <div className={styles.card}>
        ...
        <div className={styles.card__dateAndLocation}>
          <div className={styles.dateAndLocation__date}>
            ...
            <span className={styles.dateAndLocation__date__from}>
              {props.date_from}
            </span>
            {" - "}
            <span className={styles.dateAndLocation__date__to}>
              {props.date_to}
            </span>
          </div>
          <div className={styles.dateAndLocation__location}>
            <a
              className={styles.dateAndLocation__location__link}
              href={props.location_link}
            >
              <div
                className={styles.dateAndLocation__location__link__locationIcon}
              >
                <FaCity size={14} />
              </div>
              {props.location_name}
